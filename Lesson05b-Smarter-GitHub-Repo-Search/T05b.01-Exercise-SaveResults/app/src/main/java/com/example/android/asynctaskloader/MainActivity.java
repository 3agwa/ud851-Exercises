...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String rawSearchJson = "result";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            if (savedInstanceState.containsKey(queryURL))
            {
                mUrlDisplayTextView.setText(savedInstanceState.getString(queryURL));
            }
            if (savedInstanceState.containsKey(rawSearchJson))
            {
                mSearchResultsTextView.setText(savedInstanceState.getString(rawSearchJson));
            }
        }
    }
