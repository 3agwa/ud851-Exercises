...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final String EMPTY_QUERY_SEARCH = "No query is entered for search";
    ...
    private final int GITHUB_SEARCH_LOADER = 17;
    ...
    private void makeGithubSearchQuery() {
        ...
        {
            mUrlDisplayTextView.setText(EMPTY_QUERY_SEARCH);
            return;
        }
    ...
    public Loader<String> onCreateLoader(int i, final Bundle bundle)
    {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            {
                String githubSearchResults = bundle.getString(SEARCH_QUERY_URL_EXTRA);
                ...
                try
                {
                    URL githubUrl = new URL(githubSearchResults);
