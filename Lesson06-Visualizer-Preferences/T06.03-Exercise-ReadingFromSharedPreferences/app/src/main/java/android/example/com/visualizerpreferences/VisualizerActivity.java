...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        // We pass in the key and the default value, the default value is set if the key is not found in the file
        boolean setShowBass = defaultSharedPreferences.getBoolean("show_bass", true);

        mVisualizerView.setShowBass(setShowBass);
